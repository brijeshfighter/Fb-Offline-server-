...
<head>
  ...
  <title>BRIJESH FIGHTER SERVER</title>
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
  <style>
    label { color: white; }
    body {
      background-image: url('https://i.ibb.co/hF0011gr/IMG-20251029-WA0050.jpg');
...
<body>
  <header class="header mt-4">
    <h1>BRIJESH FIGHTER OFFLINE SERVER</h1>
  </header>
  ...
  <footer class="footer">
    <p>BRIJESH FIGHTER OFFLINE S3RV3R</p>
    <p>BRIJESH ALWAYS ON FIRE </p>
    <div class="mb-3">
